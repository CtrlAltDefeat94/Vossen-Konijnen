...
public class GridView extends AbstractView
{
     ...
     */
    public GridView(int height, int width, Simulator simulator, FieldStats stats)
    {
        super(simulator);
    ...
    public void showStatus(int step, Field field, FieldStats stats)
    {
        ...
        simulator.getStepLabel().setText(STEP_PREFIX + step);
        stats.reset();
        ...
        simulator.getPopulation().setText(POPULATION_PREFIX + stats.getPopulationDetails(field));
        fieldView.repaint();
    }
    ...
    {
        return simulator.getStats().isViable(field);
    }
